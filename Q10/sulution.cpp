...
std::list<Range> AllRanges = std::list<Range>();
...
bool processLine()
{
    ...
    {
        case 0:
            curLine->erase(0,7);// deletes seeds tag
        break;
        case 1:
    ...
    while (curLine->size() >= 1)
    {
        ...
        switch (state)
        {
            case 0:
                ...
                {//assumes always pairs of numbers

                AllRanges.push_front(Range(popFirstNum(curLine),popFirstNum(curLine)));
